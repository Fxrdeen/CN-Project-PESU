...
class Otherusers extends Component {
  ...
  onKey(evt) {
    if (evt.key === "Enter") {
      Meteor.call("messages.insert", this.state.message, (err, res) => {
        if (err) {
          ...
          if (err) {
            ...
            Meteor.call(
              ...
              (err, res) => {
                ...
                alert("you are the winner! Congratulations!", res);
    ...
    return (
      <div>
        ...
        {this.props.canvas[0] ? (
          <img
            id="bloom"
            src={this.props.canvas[0].canvasState}
            alt="from canvas"
          />
        ) : (
          <div />
...
export default withTracker(() => {
  ...
  return {
    ...
    user: Meteor.user(),
    ready:
      handle.ready() || c.ready() || subanswer.ready() || subwinner.ready(),
